...
Usually the presenter just shares their screen and explains how the code (or something else) works. People may interrupt and ask questions right away or ask the presenter to go into detail. It always brings up interesting conversations!
